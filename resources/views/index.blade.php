            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Area Chart -->
                        <div class="col-sm-12">
                            <div class="card shadow" style="height: 860px; background-color: #ffffff;">
                                    ...
                                    <div class="chart-area col" style="position: relative;">
                                        ...
                                        @foreach($product as $key => $data)
                                            ...
                                            <div style="width: 100%;">
                                                ...
                                                <span><img src="{{ asset('assignment2/resources/image/'.$data->image) }}" style=" max-width: 230px ;height: 232px;margin-left: 20px;" alt=""></span>
                                                <div class="detail">
